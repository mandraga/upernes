...
textcpy:
	...
	lda #$00
	sta VMADDL		; Word address (= $1800word)
	lda #$18
	sta VMADDH
	; Counters
...
BG3strloop:
	...
	lda #$00		; Second set of 256 tiles
...
Print:
	...
	; ASCII CHR is at $1800 = $2000 + 6 x 1024 first tile is at 128+256. Offset 256 in the high byte set by the
